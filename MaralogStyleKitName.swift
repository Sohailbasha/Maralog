...
public class MaralogStyleKitName : NSObject {
    ...
    private struct Cache {
        ...
        static let gradient: CGGradient = CGGradient(colorsSpace: nil, colors: [MaralogStyleKitName.gradientColor2.cgColor, MaralogStyleKitName.gradientColor.cgColor] as CFArray, locations: [0, 1])!
        static let gradient2: CGGradient = CGGradient(colorsSpace: nil, colors: [gradient2Color.cgColor, gradient2Color2.cgColor] as CFArray, locations: [0, 0.99])!
    ...
    public dynamic class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 97), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Color Declarations
        let gradientColor3 = UIColor(red: 0.880, green: 0.280, blue: 0.280, alpha: 1.000)
        let gradientColor4 = UIColor(red: 0.720, green: 0.520, blue: 0.840, alpha: 1.000)

        //// Gradient Declarations
        let gradient3 = CGGradient(colorsSpace: nil, colors: [gradientColor3.cgColor, gradientColor4.cgColor] as CFArray, locations: [0, 1])!
    ...
    public dynamic class func drawGradientBackground(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 667), resizing: ResizingBehavior = .aspectFit) {
        ...
        context.drawLinearGradient(MaralogStyleKitName.gradient,
    ...
    public dynamic class var imageOfCanvas1: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 124, height: 97), false, 0)
            MaralogStyleKitName.drawCanvas1()
    ...
    public dynamic class var imageOfGradientBackground: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 375, height: 667), false, 0)
            MaralogStyleKitName.drawGradientBackground()
    ...
    @IBOutlet dynamic var canvas1Targets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: MaralogStyleKitName.imageOfCanvas1)
            }
        }
    }
    ...
    @IBOutlet dynamic var gradientBackgroundTargets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: MaralogStyleKitName.imageOfGradientBackground)
            }
        }
    }
    ...
    @objc(MaralogStyleKitNameResizingBehavior)

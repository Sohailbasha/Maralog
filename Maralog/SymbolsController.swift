...
class SymbolsController {
    ...
    init() {
        ...
        let symbol3: Symbols = Symbols(description: "Recently Added. A list of people you've met in the last three days", icon: #imageLiteral(resourceName: "tbRecentlyAdded"))

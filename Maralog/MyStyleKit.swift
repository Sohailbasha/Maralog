...
public class MyStyleKit : NSObject {
    ...
    private struct Cache {
        static let gradientColor: UIColor = UIColor(red: 0.991, green: 0.991, blue: 0.991, alpha: 1.000)
        static let gradientColor2: UIColor = UIColor(red: 0.939, green: 0.939, blue: 0.939, alpha: 1.000)
